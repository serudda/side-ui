...
export const SlideOver = ({
  ...
  const classes = {
    ...
    header: cn('flex justify-between items-center', 'pt-2', {
  ...
  return (
    <aside className={classes.container}>
      <header className={classes.header}>
        <span className="text-2xl font-semibold text-inherit">{title}</span>
        <Button isOnlyIcon size={ButtonSize.xs} onClick={onClick} variant={ButtonVariant.ghost}>
          <Icon icon={IconCatalog.xMark} className="w-6" />
        </Button>
      </header>
